            ...
            const initialiseFeedback = () => {
              ...
              script.onload = async function () {
                new window.TiramaiFeedbackLib({
                  // Required
                  apiKey: "eyJidXNpbmVzc0lkZWFJZCI6Ijk0NzRmNDJjLWRkZGUtNGZhNi05ZWFhLTBlM2VkMmYzNTgyNSIsImNyZWF0ZWRBdCI6MTc2NjkyNzA0NzgzMiwiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",

                  // Context
                  businessIdeaId: "9474f42c-ddde-4fa6-9eaa-0e3ed2f35825",
                  projectName: "skillbridge-admin-portal",
...
const initialiseRefiner = () => {
  ...
  script.onload = function () {
    ...
    new window.RefinerLib({
      ...
      personaRole: "System Administrator",
      appTitle: "skillbridge-admin-portal",
      appType: "business",
      businessIdeaId: "9474f42c-ddde-4fa6-9eaa-0e3ed2f35825",
      environment: "development",
    });
