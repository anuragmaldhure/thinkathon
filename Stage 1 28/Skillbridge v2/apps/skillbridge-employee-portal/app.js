            ...
            const initialiseFeedback = () => {
              ...
              script.onload = async function () {
                new window.TiramaiFeedbackLib({
                  // Required
                  apiKey: "eyJidXNpbmVzc0lkZWFJZCI6Ijk0NzRmNDJjLWRkZGUtNGZhNi05ZWFhLTBlM2VkMmYzNTgyNSIsImNyZWF0ZWRBdCI6MTc2NjkyNzA1Mzk5OCwiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",

                  // Context
                  businessIdeaId: "9474f42c-ddde-4fa6-9eaa-0e3ed2f35825",
                  projectName: "skillbridge-employee-portal",
              ...
              try {
                ...
                script.onload = function () {
                  new window.TiramaiHelpBotLib({
                    ...
                    apiKey: "eyJidXNpbmVzc0lkZWFJZCI6Ijk0NzRmNDJjLWRkZGUtNGZhNi05ZWFhLTBlM2VkMmYzNTgyNSIsImNyZWF0ZWRBdCI6MTc2NjkyNzA1Mzk5OSwiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",
...
const initialiseRefiner = () => {
  ...
  script.onload = function () {
    ...
    new window.RefinerLib({
      ...
      personaRole: "Employee",
      appTitle: "skillbridge-employee-portal",
      appType: "business",
      businessIdeaId: "9474f42c-ddde-4fa6-9eaa-0e3ed2f35825",
      environment: "development",
    });
