            ...
            const initialiseFeedback = () => {
              ...
              script.onload = async function () {
                new window.TiramaiFeedbackLib({
                  // Required
                  apiKey: "eyJidXNpbmVzc0lkZWFJZCI6Ijk0NzRmNDJjLWRkZGUtNGZhNi05ZWFhLTBlM2VkMmYzNTgyNSIsImNyZWF0ZWRBdCI6MTc2NjkyNzA1MjkxNiwiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",

                  // Context
                  businessIdeaId: "9474f42c-ddde-4fa6-9eaa-0e3ed2f35825",
                  projectName: "skillbridge-team-management-portal",
                  personaRole: "Team Lead",
                  email: "N/A",
              ...
              try {
                ...
                script.onload = function () {
                  new window.TiramaiHelpBotLib({
                    ideaId: "9474f42c-ddde-4fa6-9eaa-0e3ed2f35825",
                    apiKey: "eyJidXNpbmVzc0lkZWFJZCI6Ijk0NzRmNDJjLWRkZGUtNGZhNi05ZWFhLTBlM2VkMmYzNTgyNSIsImNyZWF0ZWRBdCI6MTc2NjkyNzA1MjkyMiwiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",
...
const initialiseRefiner = () => {
  ...
  script.onload = function () {
    ...
    new window.RefinerLib({
      ...
      personaRole: "Team Lead",
      appTitle: "skillbridge-team-management-portal",
      appType: "business",
      businessIdeaId: "9474f42c-ddde-4fa6-9eaa-0e3ed2f35825",
      environment: "development",
    });
